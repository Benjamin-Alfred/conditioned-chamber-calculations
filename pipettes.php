...
if (!is_user_logged_in()) {
    ...
    include('controllers/PipettesController.php');
        ...
        <main id="main" class="site-main" role="main">
            ...
            <?php
                if(hasRole('USER_ADMIN') || hasRole('CALIBRATOR') || hasRole('REVIEWER') || hasRole('APPROVER')){
                    include($COEPageURI['pipettes'][$COEPage]);
                }else{
...
<?php 
    ...
    include('views/pipettes/dialogs.php');

    get_footer();

    include('views/pipettes/js.php');
