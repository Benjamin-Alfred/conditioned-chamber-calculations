...
jQuery( document ).ready(function( $ ) {
    ...
    $( "#status-pass" ).click(function() {
        url = "<?php echo get_site_url().'/pipettes/'; ?>";
    ...
    $( "#save-imported-certificate" ).click(function() {
        url = "<?php echo get_site_url().'/pipettes/'; ?>";
        console.log($( "#certificate_details").val());
        $.post( url, 
            {
                ccc_id: $( "#ccc_id").val(), 
                certificate_details: $( "#certificate_details").val(),
                xml_schema_type: $( "#xml_schema_type").val(),
                validity: $( "#validity").val(),
                show_calibration_certificate: "true"
            } )
            .done(function(data) {
                $( "#ccc_back" ).submit();
            });
