...
<div class="row justify-content-end" style="padding-bottom: 20px;">
    <form name="ccc_post" method="POST" action="<?php echo get_site_url(); ?>/pipettes/">
...
<div class="">
    <table class="table table-striped table-sm table-bordered" style="font-size: 0.8rem;" id="pipettes-list" data-page-length="25">
        <thead>
            <tr>
