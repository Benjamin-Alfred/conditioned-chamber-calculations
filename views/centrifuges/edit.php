...
<div>
    <form name="ccc_back" method="POST" action="<?php echo get_site_url(); ?>/centrifuges/">
        <button class="btn btn-sm btn-outline-dark float-right" onclick="document.ccc_back.submit">Back</button>
    </form>
    <br>
    <br>
    <form name="calibration_calculations_form" method="POST" action="<?php echo get_site_url(); ?>/centrifuges/">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label for="expected_set_point_d" class="col-form-label col-sm-5">Set Point 4</label>
                    <input type="number" step="any" class="form-control form-control-sm col-sm-7" id="expected_set_point_d" name="expected_set_point_d" value="<?php echo $certification->expected_set_point_d; ?>" required />
                </div>
                <div class="form-group row">
                    <label for="expected_set_point_e" class="col-form-label col-sm-5">Set Point 5</label>
                    <input type="number" step="any" class="form-control form-control-sm col-sm-7" id="expected_set_point_e" name="expected_set_point_e" value="<?php echo $certification->expected_set_point_e; ?>" required />
                </div>
            </div>
        </div>
        <div class="card">
                    ...
                    <table class="table table-bordered table-sm">
                        <thead>
                            <tr>
                                ...
                                <th scope="col" colspan="5"><center>Set Points</center></th>
                            </tr>
                            <tr>
                                <th scope="col">1</th>
                                <th scope="col">2</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_4_1" name="reading_4_1" required value="<?php echo $certification->readings[0]['reading_d']; ?>" />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_5_1" name="reading_5_1" required value="<?php echo $certification->readings[0]['reading_e']; ?>" />
                                </td>
                            </tr>
                            <tr>
                                <td>Reading 2</td>
                                ...
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_4_2" name="reading_4_2" required value="<?php echo $certification->readings[1]['reading_d']; ?>" />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_5_2" name="reading_5_2" required value="<?php echo $certification->readings[1]['reading_e']; ?>" />
                                </td>
                            </tr>
                            <tr>
                                <td>Reading 3</td>
                                ...
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_4_3" name="reading_4_3" required value="<?php echo $certification->readings[2]['reading_d']; ?>" />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_5_3" name="reading_5_3" required value="<?php echo $certification->readings[2]['reading_e']; ?>" />
                                </td>
                            </tr>
                            <tr>
                                <td>Reading 4</td>
                                ...
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_4_4" name="reading_4_4" required value="<?php echo $certification->readings[3]['reading_d']; ?>" />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_5_4" name="reading_5_4" required value="<?php echo $certification->readings[3]['reading_e']; ?>" />
                                </td>
                            </tr>
                            <tr>
                                <td>Reading 5</td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_1_5" name="reading_1_5" required value="<?php echo $certification->readings[4]['reading_a']; ?>" />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_2_5" name="reading_2_5" required value="<?php echo $certification->readings[4]['reading_b']; ?>" />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_3_5" name="reading_3_5" required value="<?php echo $certification->readings[4]['reading_c']; ?>" />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_4_5" name="reading_4_5" required value="<?php echo $certification->readings[4]['reading_d']; ?>" />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_5_5" name="reading_5_5" required value="<?php echo $certification->readings[4]['reading_e']; ?>" />
                                </td>
                            </tr>
                        </tbody>
                    </table>
