...
<div class="">
    <table class="table table-striped table-sm table-bordered" style="font-size: 0.8rem;" id="centrifuges-list" data-page-length="25">
        <thead>
            <tr>
            ...
            ?>
                    <td>
                        <form name="ccc_cert" id="ccc_cert" method="POST"
                            action="<?php echo get_site_url(); ?>/centrifuges/" class="inline-form">
