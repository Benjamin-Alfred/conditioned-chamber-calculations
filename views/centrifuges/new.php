        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="form-group row">
                    ...
                    <input type="number" step="any" class="form-control form-control-sm col-sm-7" id="expected_set_point_d" name="expected_set_point_d" title="Set Point 4" required />
                </div>
                <div class="form-group row">
                    <label for="expected_set_point_e" class="col-form-label col-sm-5">Set Point 5</label>
                    <input type="number" step="any" class="form-control form-control-sm col-sm-7" id="expected_set_point_e" name="expected_set_point_e" title="Set Point 5" required />
                </div>
            </div>
        </div>
        <div class="card">
                    ...
                    <table class="table table-bordered table-sm">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_4_1" name="reading_4_1" required />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_5_1" name="reading_5_1" required />
                                </td>
                            </tr>
                            <tr>
                                <td>Reading 2</td>
                                ...
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_4_2" name="reading_4_2" required />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_5_2" name="reading_5_2" required />
                                </td>
                            </tr>
                            <tr>
                                <td>Reading 3</td>
                                ...
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_4_3" name="reading_4_3" required />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_5_3" name="reading_5_3" required />
                                </td>
                            </tr>
                            <tr>
                                <td>Reading 4</td>
                                ...
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_4_4" name="reading_4_4" required />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_5_4" name="reading_5_4" required />
                                </td>
                            </tr>
                            <tr>
                                <td>Reading 5</td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_1_5" name="reading_1_5" required />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_2_5" name="reading_2_5" required />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_3_5" name="reading_3_5" required />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_4_5" name="reading_4_5" required />
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control form-control-sm" id="reading_5_5" name="reading_5_5" required />
                                </td>
                            </tr>
                        </tbody>
                    </table>
